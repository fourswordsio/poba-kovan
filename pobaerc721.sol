/**
 *ERC721 full token - returns a table with all tokens and includes burn function
 * version 5 remove unused functions unused functions from version 4
*/
...
contract ERC721Enumerable is ERC165, ERC721, IERC721Enumerable {
   ...
   * @return table
   */
  function totalTokensID() public view returns (uint256[]) {
    return (_allTokens);
  }
...
// File: contracts/POBAasset

contract POBAasset is ERC721Mintable, ERC721Pausable {


    string public tokenURIPrefix = "www.pobatag.com/images/Poba-";

    constructor() public ERC721Full("POBA Assets", "POBA") {}
    ...
    function mintPobaAsset(address _owner, uint256 _tokenId) public onlyMinter {
        _mint(_owner, _tokenId);
    }
    
    function burnPobaAsset(address _owner, uint256 _tokenId) public onlyMinter {
